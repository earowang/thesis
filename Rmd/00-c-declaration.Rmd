...
\hline
4 & Data representation, visual and analytical techniques for demystifying temporal missing data & Not yet to be submitted & xx & xx & \multicolumn{1}{c|}{N} \\
\hline
\end{tabular}
\end{table}
