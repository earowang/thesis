...
```{r h4, fig.height = 7, fig.cap = "Calendar display for household 4, shows energy use mostly in the evenings and on weekends. Three short trips were taken in October, December, April, and June."}
```
