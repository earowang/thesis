...
```{r animate, fig.show = "animate", fig.height = 6.5, fig.cap = "(ref:animate-cap)", interval = 0.5, aniopts = c("autoplay", "controls", "loop"), eval = knitr::is_latex_output()}
```

```{r animate, fig.show = "animate", fig.height = 6.5, fig.cap = "(ref:animate-cap)", interval = 0.5, ffmpeg.format = "gif", dev = "png", eval = knitr::is_html_output(), fig.process = "animate.gif"}
```
