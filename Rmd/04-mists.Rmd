...
```{r spencer-spinoplot, fig.height = 3, fig.width = 3, out.width = "0.5\\linewidth", fig.cap = "(ref:spencer-spinoplot-cap)", eval = is_latex_output()}
```

```{r spencer-spinoplot, fig.height = 3, fig.width = 3, fig.cap = "(ref:spencer-spinoplot-cap)", eval = is_html_output()}
```
