...
There are some natural next directions of this work. The literature review uncovered the lack of a comprehensive system for simulating different types of missing value patterns. Conceptualizing and developing a system would greatly help in understanding what is seen in practice. Much of the early work on exploratory methods for missings is used in interactive graphical methods. The methods developed in this paper could be developed to incorporate interaction, as new technology arises that makes this easier.
