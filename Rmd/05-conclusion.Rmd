...
Three primary types of activities that shape this thesis are presentations, package development, and writing. I have developed a habit of using Git/Github to track and synchronize my academic work since I started the PhD program. Figure \@ref(fig:phd-ghcommits) presents all the commits grouped by the activity types, with annotations of the important milestones.
